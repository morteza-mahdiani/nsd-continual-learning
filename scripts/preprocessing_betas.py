...
conditions = get_conditions(data_dir, subj, n_sessions=5)
...
betas_file = './data/subj01_beta_5.npy'
targetspace = "func1pt8mm"

# Load raw betas for inspection
raw_betas = get_betas(data_dir, subj, n_sessions=5, targetspace=targetspace)
...
betas = load_or_compute_betas_average(betas_file=betas_file, nsd_dir=data_dir, subj=subj, n_sessions=5, conditions=conditions, conditions_sampled=conditions_sampled, targetspace=targetspace)
